...
#include "mbedtls/private/mldsa.h"


/** Load the contents of a key buffer into an internal MLDSA representation
 *
 ...
 * \param[out] p_mldsa      Returns a pointer to an MLDSA context on success.
...
/** Import an MLDSA key in binary format.
 *
 ...
 *
 * \retval #PSA_SUCCESS  The MLDSA key was imported successfully.
...
/** Export an MLDSA public key or the public part of an MLDSA key pair in binary
 *  format.
 *
 * \note The signature of this function is that of a PSA driver
 ...
 *                              \p data
 *
 * \retval #PSA_SUCCESS  The MLDSA public key was exported successfully.
 * \retval #PSA_ERROR_NOT_SUPPORTED \emptydescription
 ...
 * \param[in]  key_buffer_size      Size of \p key_buffer in bytes.
 * \param[in]  alg                  The algorithm used for hashing.
 * \param[in]  hash                 Buffer holding the hash data.
...
/**
 * \brief Generate a signature of a hash.
 *
 * \param[in]  attributes           The attributes for the MLDSA key to generate.
 * \param[in]  key_buffer           Buffer holding the key data.
 * \param[in]  key_buffer_size      Size of \p key_buffer in bytes.
