...
#if defined(PSA_WANT_KEY_TYPE_MLKEM_PUBLIC_KEY)
#define MBEDTLS_PSA_BUILTIN_KEY_TYPE_MLKEM_PUBLIC_KEY 1
#endif /* PSA_WANT_KEY_TYPE_MLKEM_PUBLIC_KEY */
...
#endif /* PSA_WANT_KEY_TYPE_ML_DSA_KEY_PAIR_BASIC */
...
#endif /* !MBEDTLS_PSA_ACCEL_ALG_SHAKE128 */
